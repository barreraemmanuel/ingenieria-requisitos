...
|---|---|---|
| `lint_metodo.py` | La forma del workspace: árbol congelado, frontmatters, estados, archivo, coherencia worktrees↔unidades | Si lo escrito es **verdad**. Valida que un frontmatter diga `mergeada`, no que se haya mergeado nada. Es un validador **hacia dentro**: sección a sección comprueba una pieza contra sí misma |
